...
const SignUp = ({ navigation }) => {
    ...
    const handleSubmit = async () => {
        if (Validate()) {
            ...
            // }) ///////// ANOTHER WAY TO DO AUTHENTICATION
        ...
        <View style={{
            ...
            <View style={styles.view}>
                ...
                <Pressable onPress={() => {
                    ...
                    <Text style={{ backgroundColor: 'red', fontSize: 18, width: 370, height: 40, textAlign: 'center', paddingTop: 8, color: 'white', fontWeight: '600', top: 20 }}>
                        Register
                    </Text>
                </Pressable>
